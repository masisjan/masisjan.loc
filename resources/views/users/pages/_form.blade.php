<div class="input-container delete">
    ...
    @if($page->image)
        <div id="image">
            <img src="{{ asset('storage/uploads/image/pages/'. $page->image) }}" style="width:300px" alt="">
            <input type="hidden" id="imgdelete" name="image_delete" value="">
            <span onclick="deleteImg('image')" ><i class="fas fa-times-circle"></i></span>
            <p>Փոփոխել նկարը</p>
        </div>
        <input type="file" name="image" value="{{ old('image', $page->image) }}" class=" @error('image') is-invalid @enderror">
    @else
        <input type="file" name="image" value="{{ old('image', $page->image) }}" class=" @error('image') is-invalid @enderror">
        @error('image')
...
<div class="input-container">
    ...
    <input type="hidden" id="cord0" name="cord0" value="{{ old('cord0', $page->cord0) }}">
    <input type="hidden" id="cord1" name="cord1" value="{{ old('cord1', $page->cord1) }}">
    <br>
</div>
...
<div class="input-container clearfix">
    <div class="col col_6 ">
        ...
        <p>Ղեկավար</p>
        <input type="text" name="director" value="{{ old('director', $page->director) }}"
        ...
        @enderror
        <p>Հասցե</p>
        <input type="text" name="address" value="{{ old('address', $page->address) }}"
        ...
        @enderror
        <p>Էլ․ փոստ</p>
        <input type="text" name="email" value="{{ old('email', $page->email) }}"
        ...
        @enderror
        <p>Վեբ կայք</p>
        <input type="text" name="site" value="{{ old('site', $page->site) }}"
        ...
        @enderror
        <p>ֆեյսբուքյան էջ</p>
        <input type="text" name="fb" value="{{ old('fb', $page->fb) }}"
    ...
    <div class="col col_6">
        ...
        <p>Երկուշաբթի</p>
        <input type="text" name="monday" value="{{ old('monday', $page->monday) }}"
        ...
        @enderror
        <p>Երեքշաբթի</p>
        <input type="text" name="tuesday" value="{{ old('tuesday', $page->tuesday) }}"
        ...
        @enderror
        <p>Չորեքշաբթի</p>
        <input type="text" name="wednesday" value="{{ old('wednesday', $page->wednesday) }}"
        ...
        @enderror
        <p>Հինգշաբթի</p>
        <input type="text" name="thursday" value="{{ old('thursday', $page->thursday) }}"
        ...
        @enderror
        <p>Ուրբաթ</p>
        <input type="text" name="friday" value="{{ old('friday', $page->friday) }}"
        ...
        @enderror
        <p>Շաբաթ</p>
        <input type="text" name="saturday" value="{{ old('saturday', $page->saturday) }}"
        ...
        @enderror
        <p>Կիրակի</p>
        <input type="text" name="sunday" value="{{ old('sunday', $page->sunday) }}"
...
<div class="input-container">
    <p>Այլ նշումներ</p>
    <pre><textarea type="text" name="text" class="form-control @error('text') is-invalid @enderror" rows="13">{{ old('text', $page->text) }}</textarea>
    </pre>
...
<hr>
<button type="submit" class="btn btn-primary button1 button1_text bg_save">{{ $page->exists ? 'Update' : 'Save' }}</button>
