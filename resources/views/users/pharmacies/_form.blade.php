<div class="input-container delete">
    ...
    @if($pharmacy->image)
        <div id="image">
            <img src="{{ asset('storage/uploads/image/pharmacies/'. $pharmacy->image) }}" style="width:300px" alt="">
            <input type="hidden" id="imgdelete" name="image_delete" value="">
            <span onclick="deleteImg('image')" ><i class="fas fa-times-circle"></i></span>
            <p>Փոփոխել նկարը</p>
        </div>
        <input type="file" name="image" value="{{ old('image', $pharmacy->image) }}" class=" @error('image') is-invalid @enderror">
    @else
        <input type="file" name="image" value="{{ old('image', $pharmacy->image) }}" class=" @error('image') is-invalid @enderror">
        @error('image')
...
<div class="input-container">
    <p>Անվանում</p>
    <input type="text" name="title" value="{{ old('title', $pharmacy->title) }}" class="form-control @error('title') is-invalid @enderror">
    @error('title')
        <div class="c_red">
           {{ $message }}
        </div>
...
<div class="input-container">
    ...
    <input type="hidden" id="cord0" name="cord0" value="{{ old('cord0', $pharmacy->cord0) }}">
    <input type="hidden" id="cord1" name="cord1" value="{{ old('cord1', $pharmacy->cord1) }}">
    <br>
</div>
...
<div class="input-container clearfix">
    <div class="col col_6 ">
        ...
        <p>Ղեկավար</p>
        <input type="text" name="director" value="{{ old('director', $pharmacy->director) }}"
        ...
        @enderror
        <p>Էլ․ փոստ</p>
        <input type="text" name="email" value="{{ old('email', $pharmacy->email) }}"
        ...
        @enderror
        <p>Վեբ կայք</p>
        <input type="text" name="site" value="{{ old('site', $pharmacy->site) }}"
        ...
        @enderror
        <p>ֆեյսբուքյան էջ</p>
        <input type="text" name="fb" value="{{ old('fb', $pharmacy->fb) }}"
    ...
    <div class="col col_6">
        ...
        <p>Երկուշաբթի</p>
        <input type="text" name="monday" value="{{ old('monday', $pharmacy->monday) }}"
        ...
        @enderror
        <p>Երեքշաբթի</p>
        <input type="text" name="tuesday" value="{{ old('tuesday', $pharmacy->tuesday) }}"
        ...
        @enderror
        <p>Չորեքշաբթի</p>
        <input type="text" name="wednesday" value="{{ old('wednesday', $pharmacy->wednesday) }}"
        ...
        @enderror
        <p>Հինգշաբթի</p>
        <input type="text" name="thursday" value="{{ old('thursday', $pharmacy->thursday) }}"
        ...
        @enderror
        <p>Ուրբաթ</p>
        <input type="text" name="friday" value="{{ old('friday', $pharmacy->friday) }}"
        ...
        @enderror
        <p>Շաբաթ</p>
        <input type="text" name="saturday" value="{{ old('saturday', $pharmacy->saturday) }}"
        ...
        @enderror
        <p>Կիրակի</p>
        <input type="text" name="sunday" value="{{ old('sunday', $pharmacy->sunday) }}"
...
<div class="input-container">
    <p>Այլ նշումներ</p>
    <pre><textarea type="text" name="text" class="form-control @error('text') is-invalid @enderror" rows="13">{{ old('text', $pharmacy->text) }}</textarea>
    </pre>
    @error('text')
    <div class="c_red">
        {{ $message }}
...
<hr>
<button type="submit" class="btn btn-primary button1 button1_text bg_save">{{ $pharmacy->exists ? 'Update' : 'Save' }}</button>
