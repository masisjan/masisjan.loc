<div class="input-container delete">
    ...
    @if($taxi->image)
        <div id="image">
            <img src="{{ asset('storage/uploads/image/taxis/'. $taxi->image) }}" style="width:300px" alt="">
            <input type="hidden" id="imgdelete" name="image_delete" value="">
            <span onclick="deleteImg('image')" ><i class="fas fa-times-circle"></i></span>
            <p>Փոփոխել նկարը</p>
        </div>
        <input type="file" name="image" value="{{ old('image', $taxi->image) }}" class=" @error('image') is-invalid @enderror">
    @else
        <input type="file" name="image" value="{{ old('image', $taxi->image) }}" class=" @error('image') is-invalid @enderror">
        @error('image')
...
<div class="input-container">
    <p>Անվանում</p>
    <input type="text" name="title" value="{{ old('title', $taxi->title) }}" class="form-control @error('title') is-invalid @enderror">
    @error('title')
        <div class="c_red">
           {{ $message }}
        </div>
...
<div class="input-container">
    ...
    <input type="hidden" id="cord0" name="cord0" value="{{ old('cord0', $taxi->cord0) }}">
    <input type="hidden" id="cord1" name="cord1" value="{{ old('cord1', $taxi->cord1) }}">
    <br>
</div>
...
<div class="input-container clearfix">
    <div class="col col_6 ">
        ...
        <p>Ղեկավար</p>
        <input type="text" name="director" value="{{ old('director', $taxi->director) }}"
        ...
        @enderror
        <p>Հասցե</p>
        <input type="text" name="address" value="{{ old('address', $taxi->address) }}"
        ...
        @enderror
        <p>Հեռախոս</p>
        <input type="text" name="phone" value="{{ old('phone', $taxi->phone) }}"
        ...
        @enderror
        <p>Էլ․ փոստ</p>
        <input type="text" name="email" value="{{ old('email', $taxi->email) }}"
        ...
        @enderror
        <p>Վեբ կայք</p>
        <input type="text" name="site" value="{{ old('site', $taxi->site) }}"
        ...
        @enderror
        <p>ֆեյսբուքյան էջ</p>
        <input type="text" name="fb" value="{{ old('fb', $taxi->fb) }}"
    ...
    <div class="col col_6">
        ...
        <p>Երկուշաբթի</p>
        <input type="text" name="monday" value="{{ old('monday', $taxi->monday) }}"
        ...
        @enderror
        <p>Երեքշաբթի</p>
        <input type="text" name="tuesday" value="{{ old('tuesday', $taxi->tuesday) }}"
        ...
        @enderror
        <p>Չորեքշաբթի</p>
        <input type="text" name="wednesday" value="{{ old('wednesday', $taxi->wednesday) }}"
        ...
        @enderror
        <p>Հինգշաբթի</p>
        <input type="text" name="thursday" value="{{ old('thursday', $taxi->thursday) }}"
        ...
        @enderror
        <p>Ուրբաթ</p>
        <input type="text" name="friday" value="{{ old('friday', $taxi->friday) }}"
        ...
        @enderror
        <p>Շաբաթ</p>
        <input type="text" name="saturday" value="{{ old('saturday', $taxi->saturday) }}"
        ...
        @enderror
        <p>Կիրակի</p>
        <input type="text" name="sunday" value="{{ old('sunday', $taxi->sunday) }}"
...
<div class="input-container">
    <p>Այլ նշումներ</p>
    <pre><textarea type="text" name="text" class="form-control @error('text') is-invalid @enderror" rows="13">{{ old('text', $taxi->text) }}</textarea>
    </pre>
    @error('text')
    <div class="c_red">
        {{ $message }}
...
<hr>
<button type="submit" class="btn btn-primary button1 button1_text bg_save">{{ $taxi->exists ? 'Update' : 'Save' }}</button>
