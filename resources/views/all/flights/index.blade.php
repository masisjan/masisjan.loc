            ...
            @if($flights->count())
                ...
                <div class="b_border margin_15_0 clearfix news_h_sm">
                    <div class="col col_4 col_md col_4_md">
                        ...
                        @if($flight->image)
                            <img src="{{ asset('storage/uploads/image/flights/'. $flight->image) }}" class="input-container news_link p_b_img" alt="">
                        @else
                    ...
                    <div class="col col_8 col_md col_8_md">
                        <a href="{{ route('flights.show', $flight->id) }}" class="news_link "><h3 class="padding_lr_15">{{ $flight->title }}</h3></a>
                        <div class="p_date_count">
                            <i class="fa fa-eye margin_left_3"></i><span> {{ $flight->count }} դիտում</span>&nbsp;
                            <i class="fas fa-star"></i><span> {{ $flight->rating }} վարկանիշ</span>
                        </div>
                    </div>
                </div>
                @endforeach
