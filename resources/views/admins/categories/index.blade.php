...
@section('content')
            ...
            <div class="bg_k2 center clearfix">
                ...
                <div class="col col_3 col_md col_3_md icon_menu">
                    <a href=" {{ route('admins.categories.create') }} "><i class="fas fa-plus-circle margin_15_0"></i></a>
                </div>
            </div>
            <div>
                        ...
                        @foreach($categories as $index => $category)
                            <tr>
                                ...
                                <td class="icon_menu">
                                    ...
                                    <a href="{{ route('admins.categories.destroy', $category->id) }}" class="btn btn-delete btn-sm btn-circle btn-outline-danger" title="Delete"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>
                        @endforeach
