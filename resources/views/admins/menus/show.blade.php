...
@section('content')
    ...
    <div class="bg_k1 clearfix"><br>
        ...
        <div class="col col_6 ">
            <img class="img_map" src="{{asset('storage/uploads/image/admin/menu/' . $menu->image)}}" alt="">
        </div>
    </div>

        <div class="col-md-9 offset-md-3 margin_15_0">
            <a href="{{ route('admins.menus.edit', $menu->id) }}" class="btn btn-info button1 button1_text bg_edit">Edit</a>
            <a href="{{ route('admins.menus.destroy', $menu->id) }}" class="btn btn-delete btn-outline-danger button1 button1_text bg_delete">Delete</a>
