...
@section('content')
    ...
    <div class="col-md-9 offset-md-3 margin_15_0">
        <a href="{{ route('admins.posts.edit', $post->id) }}" class="btn btn-info button1 button1_text bg_edit">Edit</a>
        <a href="{{ route('admins.posts.destroy', $post->id) }}" class="btn btn-delete btn-outline-danger button1 button1_text bg_delete">Delete</a>
